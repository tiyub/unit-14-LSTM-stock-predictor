...
<sup><a id="ref001">1</a></sup> Sethi, Vansh (2020-02-16). Using LSTMs to Predict Stock Prices. Retrieved from [towardsdatascience.com](https://towardsdatascience.com/using-lstms-to-predict-stock-prices-a9965dfec2c9).

<sup><a id="ref002">2</a></sup> Kharwal, Aman (2022-01-03). Stock Price Prediction with LSTM. Retrieved from [thecleverprogrammer.com](https://thecleverprogrammer.com/2022/01/03/stock-price-prediction-with-lstm/).

<sup><a id="ref3">3</a></sup> HoloViz developers (2022-02-16). Annotating your Data. Retrieved from [holoviews.org](https://holoviews.org/user_guide/Annotating_Data.html).  

<sup><a id="ref4">4</a></sup> Holoviz contributors (2016-2022). Customization. Retrieved from [hvplot.holoviz.org](https://hvplot.holoviz.org/user_guide/Customization.html).
